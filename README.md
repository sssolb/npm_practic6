...
Для перевірки роботи серверів необхідно відкрити термінал у директорії з проєктом та запустити потрібний скрипт через середовище Node.js, обов'язково вказавши порт (наприклад, `3000`).
